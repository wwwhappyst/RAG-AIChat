...
为了方便上传到 GitHub，这个仓库默认不提交以下本地产物：
...
- 模型文件体积非常大，单文件超过 GitHub 普通仓库限制
- 索引和缓存都可以根据脚本重新生成
- 原始知识库可能包含不适合公开上传的内容

如果后续你希望把“代码仓库”和“私有数据仓库”分开管理，这个结构也更清晰。
...
这是一个“适合初学者学习 RAG 工程拆解过程”的 AI 助教项目，不只是为了得到答案，更是为了看清答案是怎样被检索、筛选、组织和生成出来的。
